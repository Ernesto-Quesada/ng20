...
module.exports = "    <div class=\"col-md-6\">\n<h5>Profile Edition should be an angular call to show the form</h5>\n        <form class=\"form\">\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"firstNameInput\"> first name </label>\n                    <input type=\"text\" name=\"firstNameInput\" [(ngModel)]=\"editInfo.firstNameInput\" id=\"firstNameInput\" class=\"form-control\" placeholder=\"name\" autofocus>\n                    <p class=\"help-block\"></p>\n                </div>\n            </div>\n                <div class=\"form-group\">\n                <label for=\"lastNameInput\"> last name </label>\n                <input type=\"text\" name=\"lastNameInput\" [(ngModel)]=\"editInfo.lastNameInput\" id=\"lastNameInput\" class=\"form-control\" placeholder=\"last name\">\n            </div>\n\n            <!--<div class=\"form-group\">\n              <label for=\"emailInput\"> Your email </label>\n              <input type=\"email\" disabled name=\"emailInput\" [(ngModel)]=\"editInfo.emailInput\" id=\"emailInput\" class=\"form-control\" placeholder=\"{{user.email}}\">\n            </div>-->\n\n            <div class=\"form-group\">\n              <label for=\"phoneInput\"> Your phone </label>\n              <input type=\"phone\" name=\"phoneInput\" [(ngModel)]=\"editInfo.phoneInput\" id=\"phoneInput\" class=\"form-control\" placeholder=\"phone\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"currentPassword\"> Current Password</label>\n              <input type=\"password\" name=\"currentPassword \" [(ngModel)]=\"editInfo.currentPassword\" class=\"form-control\" placeholder=\"current password\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"editedPassword\">New Password</label>\n              <input type=\"password\" name=\"editedPassword \" [(ngModel)]=\"editInfo.editedPassword\" class=\"form-control\" placeholder=\"new password\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"countryInput\"> Country </label>\n              <input type=\"text\" name=\"countryInput\" [(ngModel)]=\"editInfo.countryInput\" id=\"countryInput\" class=\"form-control\" placeholder=\"{country\">\n            </div>\n            <div id=\"success\"></div>\n            <!-- For success/fail messages -->\n            <button (click)=\"editProfile()\" class=\"btn btn-primary\">Done</button>\n            <button (click)=\"editProfile()\" class=\"btn btn-primary\">Done</button>\n\n        </form>\n        </div>\n"
...
var PaymentComponent = (function () {
    function PaymentComponent(mySenderService) {
...
PaymentComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__sender_service__["a" /* SenderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__sender_service__["a" /* SenderService */]) === "function" && _a || Object])
], PaymentComponent);
...
module.exports = "  <div class=\"row well\" >\n\n      \n        <div class=\"panel-heading\">\n          <h3> {{user.theUserProfile.firstName}} {{user.theUserProfile.lastName}} </h3>\n          <p> {{user.theUserProfile.email}}</p>\n          <p> {{user.theUserProfile.phone}}</p>\n          <p> {{user.theUserProfile.address}}</p>          \n        </div>\n                    \n        <div class=\"panel-body\">\n          \n          <fieldset>\n            <div class=\"panel-heading\">\n              <h3 class=\"panel-title\">You are currently using <b>{{user.theUserProfile.agencyInUseId.nameAgency}}</b> agency</h3>\n            </div>\n          </fieldset>\n        </div>\n        <div [routerLink]=\"['/profile/edit']\">Edit your profile</div>\n        <div [routerLink]=\"['/relative/new']\">Add a family member</div>\n    \n   \n  </div>"
...
module.exports = "<form class=\"new-relative\" (ngSubmit)='addRelative(relativeInfoForm)' #relativeInfoForm='ngForm' onSubmit=\"return false\">\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"name-input\"> Your Relative's Name </label>\n                    <input type=\"text\" class=\"form-control\" id=\"relativeName\" name ='relativeName' [(ngModel)]=\"relativeName\" autofocus>\n                    <p class=\"help-block\"></p>\n                </div>\n            </div>\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"firstApell\"> First Surname </label>\n                    <input class=\"form-control\"  type=\"text\" name='firstApell' [(ngModel)]=\"firstApell\" id=\"firstApell\">\n                </div> \n             </div>\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"secondApell\"> Second Surname </label>\n                    <input class=\"form-control\"  type=\"text\" name='secondApell' [(ngModel)]=\"secondApell\" id=\"secondApell\">\n                </div>\n            </div>\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"parentesco\"> Parentesco </label>\n                    <input class=\"form-control\"  type=\"text\" name='parentesco' [(ngModel)]=\"parentesco\" id=\"parentesco\">\n                </div>\n            </div>\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"addressRelative\"> Relative's Address </label>\n                    <input class=\"form-control\"  type=\"text\" name='addressRelative' [(ngModel)]=\"addressRelative\" id=\"addressRelative\">\n                </div>\n            </div> \n\n             <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"carnetId\"> carnet Id </label>\n                    <input class=\"form-control\"  type=\"text\" name='carnetId' [(ngModel)]=\"carnetId\" id=\"carnetId\">\n                </div>\n            </div> \n\n            \n\n             <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"phoneRelative\"> Relative's Phone </label>\n                    <input class=\"form-control\"  type=\"text\" name='phoneRelative' [(ngModel)]=\"phoneRelative\" id=\"phoneRelative\">\n                </div>\n            </div>\n\n            <div class=\"control-group form-group\">\n                <div class=\"controls\">\n                    <label for=\"emailRelative\"> Relative's Email </label>\n                    <input class=\"form-control\" type=\"text\" name=\"emailRelative\" [(ngModel)]=\"emailRelative\" id=\"emailRelative\">\n\n                </div>\n            </div>\n            <div id=\"success\"></div> \n            <!-- For success/fail messages -->\n          <button [routerLink]=\"['/portal/']\" class=\"btn btn-primary\">Cancel</button>\n           <input type=\"submit\" value=\"Done\">\n\n</form>\n"
